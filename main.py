...
WALL_THRESHOLD_MAIN = 1000   # Contoh: mungkin 50 BTC total dalam 100 poin harga adalah "Main Wall"
WALL_THRESHOLD_MINOR = 500  # Contoh: mungkin 20 BTC total dalam 100 poin harga adalah "Minor Wall"

SPOOF_DETECTION_THRESHOLD_PERCENT = 0.5
SPOOF_QUANTITY_MIN = 10    # Contoh: hanya cek spoofing untuk total kuantitas step >= 10 BTC
